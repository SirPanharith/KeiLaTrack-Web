...
<body class="flex items-center justify-center bg-green-700">
  <div class="w-full max-w-sm mx-auto bg-green-600 rounded-lg p-8">
    ...
    <p class="text-green-200 text-sm mb-8">An OTP has been sent to your email. Please enter the details below to reset your password.</p>
    <form action="{{ route('password.reset.post') }}" method="POST">
      ...
      <div class="mb-4">
        ...
        <div class="flex items-center bg-green-300 rounded-full px-4 py-2">
          <input type="email" id="email" name="email" class="bg-transparent flex-1 ml-2 outline-none" placeholder="Enter your email" required>
        </div>
      </div>
      <div class="mb-4">
        <label class="block text-green-200 text-sm mb-2" for="otp">OTP</label>
        <div class="flex items-center bg-green-300 rounded-full px-4 py-2">
          <input type="text" id="otp" name="otp" class="bg-transparent flex-1 ml-2 outline-none" placeholder="Enter OTP" required>
        </div>
      </div>
      <div class="mb-4">
